...
-s|--srid            PostGIS SRID. Default to 2056
...
# create the ch_fr_aquafri tables (relations)
PGSERVICE=${PGSERVICE} SRID=${SRID} ${DIR}/insert_tables.sh

# create the ch_fr_aquafri values
PGSERVICE=${PGSERVICE} SRID=${SRID} ${DIR}/insert_values.sh
